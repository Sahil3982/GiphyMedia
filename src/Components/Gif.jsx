  ...
  return (
    <Link to={`${gif.type}/${gif.slug}`}>
      <div className='w-full mb-2 relative cursor-pointer group'>
        ...
        />
        {
          true && (<div className='absolute inset-0 rounded opacity-0 group-hover:opacity-100 bg-gradient-to=b from-transparent via-transparent to-black font-bold flex items-end gap-2 p-2'>
            <img
